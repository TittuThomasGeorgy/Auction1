...
export const getStudentById = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const logoObj2 = ((_data.school as IClub).logo as unknown as IFileModel).downloadURL; // Ensure that scl.logo is properly typed
        ...
        const data: IStudent = {
            ...
            logo: logoObj ?? '',  // Use the downloadURL if it exists
            school: {
                ...(_data.toObject().school as IClub),  // Convert mongoose document to a plain object
